...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info{
    ...
    cropController.sourceImage = info[UIImagePickerControllerOriginalImage];
...
//didmiss camara when edit image
- (void)imageCropControllerCancel:(GKImageCropViewController *)imageCropController{
